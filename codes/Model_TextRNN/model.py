...
import sys
sys.path.insert(0,'/home/chada/GPU/intro_to_deep_proj/Model_TextRNN')
from utils import *
...
class TextRNN(nn.Module):
    def __init__(self, config, vocab_size, word_embeddings):
        ...
        self.softmax = nn.Softmax(dim=-1) #what is the meaning of dim? hadar's comment
    ...
    def run_epoch(self, train_iterator, val_iterator, epoch):
        ...
        for i, batch in enumerate(train_iterator):
            ...
            if i % 100 == 0:
                ...
                ###Save the accuracies to val_accuracies list###
                val_accuracies.append(val_accuracy)
                ###End of save accuracies to val_accuracies list###
                self.train()
